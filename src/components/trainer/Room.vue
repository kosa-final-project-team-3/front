<template>
  <div>
    <div class="video-container" :class="{ 'two-users': peerConnected && !expandedVideo, 'expanded': expandedVideo !== null }">
      <video ref="myVideo" autoplay playsinline muted :class="{ 'expanded-video': expandedVideo === 'myVideo', 'hidden-video': expandedVideo && expandedVideo !== 'myVideo', }" @click="expandVideo('myVideo')"></video>
      <video ref="peerVideo" v-show="peerConnected" autoplay playsinline :class="{ 'expanded-video': expandedVideo === 'peerVideo', 'hidden-video': expandedVideo && expandedVideo !== 'peerVideo', }" @click="expandVideo('peerVideo')"></video>
    </div>
